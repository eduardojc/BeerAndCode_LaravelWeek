        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-5 gap-4 flex flex-row items-end">
                        <div class="col-span-4 lg:col-span-2">
                            <InputLabel for="beer_name" value="Name" />
                            <TextInput placeholder="Nome da Cerveja" id="beer_name" type="text" class="mt-1 block w-full" v-model="form.beer_name" />
                        </div>
                        ...
                        <div class="col-span-4 lg:col-span-2">
                            ...
                            <Select v-model="form.food" placeholder="Escolher..." :options="meals" option-value="name" option-label="name" />
                        </div>
                        <div class="col-span-4 lg:col-span-1">
